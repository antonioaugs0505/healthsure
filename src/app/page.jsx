      ...
      <section id="grid" className={style.areaDestaque}>
        ...
        <div className={style.gridContainer}>
          <div className={style.grid1}>
            <p>
              Doenças transmissíveis são enfermidades causadas por agentes
              patogênicos, como bactérias, vírus, fungos ou parasitas, que podem
              ser transmitidos de uma pessoa para outra. Essas doenças se
              espalham por meio de contato direto ou indireto, muitas vezes
              facilitadas por condições inadequadas de higiene e saúde pública.
              A disseminação pode ocorrer por gotículas no ar, contato com
              superfícies contaminadas e até mesmo por vetores como mosquitos. A
              prevenção dessas enfermidades inclui medidas simples, como lavagem
              das mãos, vacinação e práticas sexuais seguras. A conscientização
              sobre a importância da saúde pública e o acesso a cuidados médicos
              são essenciais para conter a propagação dessas doenças e promover
              comunidades mais saudáveis e resilientes.
            </p>
          </div>
          <div className={style.grid2}>
            <p>
              Diversas doenças transmissíveis, como infeções respiratórias e
              gastrointestinais, além de zoonoses, são transmitidas de animais
              para humanos. As DSTs, incluindo HIV e outras, representam uma
              categoria significativa de preocupação para a saúde pública
              global. A prevenção é essencial para preservar a vida e promover
          ...
          <div className={style.grid4}>
            <p>
              Diversos vírus, como HIV, influenza e coronavírus, junto com
              bactérias como Salmonella e Escherichia coli, são comuns e
              apresentam desafios para a saúde. Vetores, como mosquitos
              responsáveis por malária e dengue, e animais domésticos, incluindo
              a raiva, desempenham papéis cruciais na disseminação dessas
              enfermidades. A prevenção é crucial para um mundo mais saudável.
            </p>
          </div>
